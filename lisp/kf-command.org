...
* dired buffer list
- https://qiita.com/zonkyy/items/35616785f9194ca00ec1
...
- [[https://github.com/kenjirofukuda/gdsfeel-js.git][gdsfeel-js]]
#+end_example
...
[[urlパート][キャプションパート]]
             ________^_________
#+end_example
カーソルがキャプションパートのレンジにある時、のみurlパートを取得。
...
#+begin_src elisp :results raw
  (kf:get-org-url-part-in-caption)
  ;;; [[https://github.com/kenjirofukuda/gdsfeel-js.git][gdsfeel-js]]
#+end_src

#+RESULTS:
https://github.com/kenjirofukuda/gdsfeel-js.git
